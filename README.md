...
그리고 처음 기획했던 보너스를 주고 리셋하는 기능도 추가해야 리플레이성을 높여 게임을 판매할 수 있을것 같다.
...
게임 프레임워크를 이용한 개발을 Java라는 새로운 언어로 해보면서,
다른 언어, 환경 프로젝트에 적용하고 있던 것들 중에 개선할 점이나 잘하고 있는 점을 발결할 수 있어 좋았다.
